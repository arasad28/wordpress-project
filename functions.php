...
function calling_our_resources(){
          ...
          wp_enqueue_style('mainstyle',get_stylesheet_uri(),'','1.0.3.2');
          ...
          wp_enqueue_style('nivo-slider-main',get_template_directory_uri() . '/css/nivo-slider.css','','1.1');



          wp_enqueue_script('nivo-slider-js1',get_template_directory_uri() . '/js/jquery.nivo.slider.js',array('jquery'),'1.3',true);

          wp_enqueue_script('nivo-slider-js2',get_template_directory_uri() . '/js/jquery-1.9.0.min.js',array('jquery'),'1.1');
